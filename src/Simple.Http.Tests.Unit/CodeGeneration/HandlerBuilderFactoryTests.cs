namespace Simple.Http.Tests.Unit.CodeGeneration
{
    using System;
    ...
    public class HandlerBuilderFactoryTests
    {
        ...
        public void SetsEnumerableStringPropertyCorrectly()
        {
            ...
            Assert.Equal(stringCollection, (IEnumerable<string>)actual.Strings);
        }
        ...
        public void SetsEnumerableEnumPropertyCorrectly()
        {
            ...
            Assert.Equal(enumCollection, (IEnumerable<Enterprise>)actual.Trekkers);
        }
